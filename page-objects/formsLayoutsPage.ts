...
export class FormLayoutsPage extends HelperBase{
    // static submitInlineFormWithNameEmailAndCheckbox(arg0: string, arg1: string, arg2: boolean) {
    //     throw new Error('Method not implemented.');
    // }
    // static submitUsingTheGridFormWithCredentialsAndSelectionOption(arg0: string, arg1: string, arg2: string) {
    //     throw new Error('Method not implemented.');
    // }
